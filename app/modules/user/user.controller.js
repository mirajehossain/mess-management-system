...
class UserController{
	...
	static async addUser(req,res){
		try {
			...
			const data = await UserLib.addUser(user);
	...
	static async changePassword(req, res){
		try {
			...
			const data = await UserLib.changPassword(id,oldPassword,newPassword);
	...
	static async userSummary(req,res) {
		try {
			...
			const summary = await UserLib.userSummary(currentMonthFirstDate, currentMonthLastDate, userId, messId);
	...
	static async messSummary(req,res){
		try {
			...
			const summary = await UserLib.messSummary(currentMonthFirstDate, currentMonthLastDate, messId);
